...
// the following code is taken from https://github.com/stormytuna/Bangarang/blob/main/Content/Projectiles/Weapons/Boomerang.cs with permission
public class CurveSickleProj : ModProjectile
{
    public override string Texture => ContentPath + "Items/CurveSickle";
    ...
    {
        Item.NewItem(Projectile.GetItemSource_DropAsItem(), Projectile.Center, ModContent.ItemType<CurveSickle>());
    }
